...
public record Material(
	...
	public Material emission       (Color  emission       ) { return emittance(emission); }
	...
	public static Material surface(Color emission, Color diffuse, Color reflective, Color refractive, double refractiveIndex) {
		return new Material(diffuse, Color.BLACK, 32.0, reflective, refractive, refractiveIndex, emission);
	}

	public static Material surface(Color diffuse, Color reflective, Color refractive, double refractiveIndex) {
		return surface(Color.BLACK, diffuse, reflective, refractive, refractiveIndex);
	}
